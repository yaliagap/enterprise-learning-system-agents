        ...
        {kbActivity?.query && (
          <div>
            ...
            {refs.length > 0 ? (
              ...
              /* Fallback: show KB query + excerpt when no structured refs */
              <div className="rounded-lg border border-slate-200 overflow-hidden">
                <div className="flex items-start gap-2.5 px-4 py-3 bg-slate-50 border-b border-slate-100">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed line-clamp-2">{kbActivity.query}</p>
                  </div>
                </div>
                {kbActivity.response_text && (
                  <div className="px-4 py-3">
                    <p className="text-xs font-medium text-slate-500 mb-1.5">Excerpt</p>
                    <p className="text-xs text-slate-600 leading-relaxed line-clamp-5 whitespace-pre-wrap">
                      {kbActivity.response_text}
                    </p>
                  </div>
                )}
